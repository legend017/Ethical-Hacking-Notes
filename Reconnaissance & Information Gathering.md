## Passive recon
It is gathering info **without touching the target.** You're using third party sources. The target has no idea you're looking.

==ping== - if the server is reachable or not , how long it takes for data to travel round-trip
...
where b specifies sources  from where it is gathered...

hunter.io is a website which does similar job like theHarvester tool but more efficiently ....
sherlock tool - Hunts down social media acc by username across social networks....
